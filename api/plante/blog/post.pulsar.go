...
func init() {
	...
	md_Post = File_plante_blog_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_plante_blog_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "plante.blog.Post.id":
		return x.Id != uint64(0)
	case "plante.blog.Post.title":
		return x.Title != ""
	case "plante.blog.Post.content":
		return x.Content != ""
	case "plante.blog.Post.creator":
		return x.Creator != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: plante.blog.Post"))
		}
		panic(fmt.Errorf("message plante.blog.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message plante.blog.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "plante.blog.Post.id":
		panic(fmt.Errorf("field id of message plante.blog.Post is not mutable"))
	case "plante.blog.Post.title":
		panic(fmt.Errorf("field title of message plante.blog.Post is not mutable"))
	case "plante.blog.Post.content":
		panic(fmt.Errorf("field content of message plante.blog.Post is not mutable"))
	case "plante.blog.Post.creator":
		panic(fmt.Errorf("field creator of message plante.blog.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: plante.blog.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in plante.blog.Post", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_plante_blog_post_proto_rawDescGZIP(), []int{0}
}
...
var File_plante_blog_post_proto protoreflect.FileDescriptor

var file_plante_blog_post_proto_rawDesc = []byte{
	0x0a, 0x16, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x65, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x70, 0x6f,
	0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x65,
	...
	,
}

var (
	file_plante_blog_post_proto_rawDescOnce sync.Once
	file_plante_blog_post_proto_rawDescData = file_plante_blog_post_proto_rawDesc
)

func file_plante_blog_post_proto_rawDescGZIP() []byte {
	file_plante_blog_post_proto_rawDescOnce.Do(func() {
		file_plante_blog_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_plante_blog_post_proto_rawDescData)
	})
	return file_plante_blog_post_proto_rawDescData
}

var file_plante_blog_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_plante_blog_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: plante.blog.Post
}
var file_plante_blog_post_proto_depIdxs = []int32{
...
func init() { file_plante_blog_post_proto_init() }
func file_plante_blog_post_proto_init() {
	if File_plante_blog_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_plante_blog_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_plante_blog_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_plante_blog_post_proto_goTypes,
		DependencyIndexes: file_plante_blog_post_proto_depIdxs,
		MessageInfos:      file_plante_blog_post_proto_msgTypes,
	}.Build()
	File_plante_blog_post_proto = out.File
	file_plante_blog_post_proto_rawDesc = nil
	file_plante_blog_post_proto_goTypes = nil
	file_plante_blog_post_proto_depIdxs = nil
}
