...
const (
	Msg_UpdateParams_FullMethodName = "/plante.blog.Msg/UpdateParams"
	Msg_SendIbcPost_FullMethodName  = "/plante.blog.Msg/SendIbcPost"
)
...
func (c *msgClient) SendIbcPost(ctx context.Context, in *MsgSendIbcPost, opts ...grpc.CallOption) (*MsgSendIbcPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SendIbcPost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SendIbcPost(context.Context, *MsgSendIbcPost) (*MsgSendIbcPostResponse, error) {
...
func _Msg_SendIbcPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SendIbcPost_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
